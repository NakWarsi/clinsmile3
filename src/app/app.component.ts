...
export class AppComponent {
  ...
  private setMetaTags() {
    this.meta.addTags([
      { name: 'description', content: 'Best dentist in Roadpali and Kalamboli, Navi Mumbai. Top dental clinic offering cosmetic dentistry, dental implants, family dentistry, teeth cleaning, veneers, and pediatric dentistry services. Call +91 8828424663 for appointments.' },
